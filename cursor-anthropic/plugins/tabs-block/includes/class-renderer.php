...
final class Renderer {
	 ...
	 * @param \WP_Block            $parent Container block instance.
	 * @return string
	 */
	private static function render_inner_blocks( array $tab, \WP_Block $parent ): string {
		$content = '';

		foreach ( $tab['innerBlocks'] ?? array() as $inner_block ) {
			$content .= ( new \WP_Block( $inner_block, $parent->context ) )->render();
		}
