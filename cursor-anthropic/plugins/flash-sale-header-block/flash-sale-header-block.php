...
/**
 * Register the block type from the compiled metadata.
 *
 * The `render` property inside `block.json` points at `render.php`, so the block is
 * rendered server-side on every request and only the countdown is hydrated on the client.
 *
 * @return void
 */
...
/**
 * Warn administrators when the block assets have not been compiled yet.
 *
 * @return void
 */
